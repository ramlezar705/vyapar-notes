...
export const PdfUpload = ({ onDone }) => {
  ...
  return (
    <div
      ...
      className={`relative rounded-xl border-2 border-dashed transition-colors p-6 ${
        dragging ? "border-emerald-500 bg-emerald-50" : "border-neutral-300 bg-white"
      }`}
    >
      <div className="flex items-center gap-4">
        <div className="shrink-0 w-12 h-12 rounded-lg bg-emerald-50 border border-emerald-100 flex items-center justify-center">
          <FilePdf size={28} weight="duotone" className="text-emerald-700" />
        </div>
        ...
        <Button
          ...
          className="bg-[#0D5C46] hover:bg-[#0a4d3a] text-white rounded-full px-5"
        >
